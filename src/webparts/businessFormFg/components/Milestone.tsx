...
const Milestone: React.FC<IProps> = ({date,value } : IProps) => {
    ...
    function MilestoneOnchanged(milestone:string)
    {
        this.setState({value: milestone});
        console.log("ContactInfo value is : "+ value);      
    }
      ...
      <div>
          ...
          {count.map( c => {
              return (                              
                      ...
                      <tr key={c}>
                        <td className={styles.dateTimePicker}><TextField value={value}  onChanged={MilestoneOnchanged.bind(this)} />
                        </td>
                        <td>
