...
import { IBusinessFormFgEditFormProps } from './IBusinessFormFgEditFormProps';
...
import {IBusinessFormFgEditFormState} from './IBusinessFormFgEditFormState';
...
export default class BusinessFormFgEditForm extends React.Component<IBusinessFormFgEditFormProps,IDatetimepickercontrolProps,IBusinessFormFgEditFormState> {
  disabled?: boolean;
  checked?: boolean;
  private listItemEntityTypeName: string = '';
  constructor(props: IBusinessFormFgEditFormProps, state: IBusinessFormFgEditFormState) {
    super(props);
    this.state = {
  ...
  public componentWillReceiveProps(nextProps: IBusinessFormFgEditFormProps): void {
  ...
  public render(): React.ReactElement<IBusinessFormFgEditFormProps> {
    return (

      <div className={styles.businessFormFgEditForm}>
...
<DefaultButton className={styles.btnSubmit} text="Reject" onClick={this._alertClicked} allowDisabledFocus disabled={false} checked={false} />
  ...
  private isListConfigured(props: IBusinessFormFgEditFormProps): boolean {
